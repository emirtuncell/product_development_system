    ...
    methods: {
        ...
        save() {
            if (this.selected_item.id) {
                this.$api.put("/scrap-causes/" + this.selected_item.id, this.selected_item).then((r) => {
                    this.fetchItems()
                    this.dialog = false
                }).catch((e) => {
                ...
                this.$api.post("/scrap-causes", this.selected_item).then((r) => {
                    this.fetchItems()
                    this.dialog = false
                }).catch((e) => {
                    console.log(e.response)
        ...
        delete_item() {
            this.$api.delete("/scrap-causes/" + this.selected_item.id).then((r) => {
